...
<button name="cus_button_search" style="position: absolute;left:950px; top:50px;">search</button>
<input type="text" name="customer_search" style="position: absolute;left:1000px ;top:50px; ">
